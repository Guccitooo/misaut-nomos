...
const translations = {
  es: {
    ...
    sevenDaysTrial: '7 DÍAS GRATIS',
    twoMonthsFree: '7 DÍAS GRATIS',
    ...
    annual: 'Anual',
    firstSevenDays: 'primeros 7 días',
    firstTwoMonths: 'primeros 7 días',
    then: 'Luego',
    perMonth: '/mes',
    ...
    whatHappensAfterTrial: '¿Qué pasa después de la prueba?',
    whatHappensAfter2Months: '¿Qué pasa después de la prueba?',
    ...
    noPermanenceExplain: 'Sí, sin permanencia. Cancela antes de los 7 días y no pagas nada.',
    ...
    additionalWorkPhotos: 'Fotos adicionales de tus trabajos',
    ...
    maxSize2MB: 'Máximo 2MB',
    logoTooLarge: 'El logo no puede superar 2MB',
    logoUploaded: 'Logo subido correctamente',
    errorUploadingLogo: 'Error al subir el logo',
    defaultInvoicingConfig: 'Configuración de facturación por defecto',
    invoiceSeries: 'Serie de facturación',
    seriesHelp: 'Ej: A, B, 2025... Las facturas se numerarán como A-2025-001',
    defaultVAT: 'IVA por defecto',
    exemptReduced: 'Exento/Reducido especial',
    superReduced: 'Superreducido',
    reduced: 'Reducido',
    general: 'General',
    applyIRPFRetention: '¿Aplicar retención IRPF?',
    retentionHelp: 'Para profesionales con retención',
    ...
    legalText: 'Texto legal para facturas',
    legalTextPlaceholder: 'Ej: Factura sujeta a retención del 15% según normativa vigente...',
    legalTextHelp: 'Este texto aparecerá al pie de todas tus facturas',
    saveSettings: 'Guardar configuración',
    ibanInvoiceHelp: 'Aparecerá en tus facturas para que los clientes sepan dónde pagar',
    issuerData: 'Datos del emisor',
    clientData: 'Datos del cliente',
    editInProfile: 'Edita estos datos en "Datos de facturación"',
    selectExistingClient: 'Cliente guardado',
    ...
    discount: 'Dto.',
    vat: 'IVA',
    exemptVAT: 'Exenta de IVA',
    taxableBase: 'Base imponible',
    totalVAT: 'Total IVA',
    irpfRetention: 'Retención IRPF',
    retentionAmount: 'Importe retención',
    totalInvoice: 'TOTAL',
    notesAndLegal: 'Notas y texto legal',
    observations: 'Observaciones',
    notesPlaceholder: 'Cualquier información adicional para el cliente...',
    legalFooter: 'Texto legal (pie de factura)',
    preview: 'Vista previa',
    invoice: 'FACTURA',
    billedTo: 'Facturar a',
    serviceConcept: 'Concepto del servicio',
    exempt: 'Exenta',
    bankDetails: 'Datos bancarios para el pago',
    searchInvoices: 'Buscar por nº factura o cliente...',
    ...
    markAsSent: 'Marcar emitida',
    markAsPaid: 'Marcar pagada',
    markOverdue: 'Marcar vencida',
    view: 'Ver',
    downloadPDF: 'Descargar PDF',
    invoicesTotal: 'facturas totales',
    ...
    invoicingSettingsSaved: 'Datos de facturación guardados',
    ...
    errorFavorites: 'Error al gestionar favoritos',
  ...
  en: {
    ...
    sevenDaysTrial: '7 DAYS FREE',
    twoMonthsFree: '7 DAYS FREE',
    ...
    whatHappensAfterTrial: 'What happens after the trial?',
    whatHappensAfter2Months: 'What happens after the trial?',
    ...
    noPermanenceExplain: 'Yes, no commitment. Cancel before 7 days and pay nothing.',
    ...
    additionalWorkPhotos: 'Additional photos of your work',
    ...
    companyName: 'Business name / Company name',
    nifCif: 'Tax ID',
    ...
    maxSize2MB: 'Maximum 2MB',
    logoTooLarge: 'Logo cannot exceed 2MB',
    logoUploaded: 'Logo uploaded successfully',
    errorUploadingLogo: 'Error uploading logo',
    defaultInvoicingConfig: 'Default invoicing configuration',
    invoiceSeries: 'Invoice series',
    seriesHelp: 'E.g.: A, B, 2025... Invoices will be numbered as A-2025-001',
    defaultVAT: 'Default VAT',
    exemptReduced: 'Exempt/Special reduced',
    superReduced: 'Super reduced',
    reduced: 'Reduced',
    general: 'General',
    applyIRPFRetention: 'Apply IRPF retention?',
    retentionHelp: 'For professionals with retention',
    retentionPercentage: 'Retention percentage',
    paymentTermDays: 'Payment term (days)',
    immediate: 'Immediate',
    defaultPaymentMethod: 'Default payment method',
    bankTransfer: 'Bank transfer',
    legalText: 'Legal text for invoices',
    legalTextPlaceholder: 'E.g.: Invoice subject to 15% retention according to current regulations...',
    legalTextHelp: 'This text will appear at the bottom of all your invoices',
    saveSettings: 'Save settings',
    ibanInvoiceHelp: 'Will appear on your invoices so clients know where to pay',
    issuerData: 'Issuer data',
    clientData: 'Client data',
    editInProfile: 'Edit this data in "Invoicing data"',
    selectExistingClient: 'Saved client',
    ...
    discount: 'Disc.',
    vat: 'VAT',
    exemptVAT: 'VAT exempt',
    taxableBase: 'Taxable base',
    totalVAT: 'Total VAT',
    irpfRetention: 'IRPF Retention',
    retentionAmount: 'Retention amount',
    totalInvoice: 'TOTAL',
    notesAndLegal: 'Notes and legal text',
    observations: 'Observations',
    notesPlaceholder: 'Any additional information for the client...',
    legalFooter: 'Legal text (invoice footer)',
    preview: 'Preview',
    invoice: 'INVOICE',
    billedTo: 'Billed to',
    ...
    searchInvoices: 'Search by invoice number or client...',
    ...
    invoicingSettingsSaved: 'Invoicing data saved',
    ...
    getMoreClients: 'Get more clients with MisAutónomos',
    unread: 'unread',
