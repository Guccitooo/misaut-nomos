...
export default function MessagesPage() {
  ...
  const handleSendMessage = async (e) => {
    ...
    const recipientUser = await base44.entities.User.filter({ id: otherUserId });
    const currentProfile = user.user_type === "professionnel" ? 
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex flex-col">
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        ...
        <p className="text-gray-600">Communiquez avec vos contacts</p>
      </div>
          ...
          <div className="flex-1 overflow-y-auto">
            {isLoading ? (
              <div className="p-4 text-center">
                <Loader2 className="w-6 h-6 animate-spin mx-auto text-blue-900" />
              </div>
            ) : conversationList.length === 0 ? (
              <div className="p-8 text-center text-gray-500">
                <MessageSquare className="w-12 h-12 mx-auto mb-3 text-gray-300" />
                <p className="font-medium">Aucune conversation</p>
                <p className="text-sm">Contactez un professionnel pour commencer</p>
              </div>
            ) : (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-400 mt-1">
                        {format(new Date(conv.lastMessage.created_date), "d MMM", { locale: fr })}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">
                      {conversations[selectedConversation]?.otherUserName || "Utilisateur"}
                    </p>
              ...
              <div className="bg-white border-t border-gray-200 p-4">
                <form onSubmit={handleSendMessage} className="flex gap-3">
                  ...
                  <Button
                    ...
                    className="h-12 bg-blue-900 hover:bg-blue-800"
                  >
